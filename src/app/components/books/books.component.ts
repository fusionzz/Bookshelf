...
export class BooksComponent implements OnInit {
  ...
  search(){
    this.filteredBooks = [...this.allBooks.filter(book => book.volumeInfo.authors[0].toLowerCase().includes(this.authorSearchText.toLowerCase()) && book.volumeInfo.title.toLowerCase().includes(this.titleSearchText.toLowerCase()))];
    this.setBooks(0);
